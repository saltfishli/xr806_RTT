...
ifeq ($(shell uname -o), Cygwin)
	@if ! [ -d ~/tools/gcc-arm-none-eabi-10-2020-q4-major ]; then \
		mkdir -p ~/tools; \
		unzip ./../tools/toolchain/gcc-arm-none-eabi/gcc-arm-none-eabi-10-2020-q4-major.zip -d ~/tools; \
	fi
else
	@if ! [ -d ~/tools/gcc-arm-none-eabi-10-2020-q4-major ]; then \
		mkdir -p ~/tools; \
		tar -jxvf ./../tools/toolchain/gcc-arm-none-eabi/gcc-arm-none-eabi-10-2020-q4-major-linux.tar.bz2 -C ~/tools; \
	fi
endif
